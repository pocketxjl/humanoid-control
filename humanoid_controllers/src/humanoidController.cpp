...
bool humanoidController::init(HybridJointInterface* robot_hw, ros::NodeHandle& controller_nh) {
  ...
  //create a ROS subscriber to receive the joint pos and vel
    ...
    jointPos_ << 0.07, -0.07, 0.35, -0.90, -0.55, 0, -0.07, 0.07, 0.35, -0.90, -0.55, 0;
...
//    std::cerr << "targetTorqueMsg: " << targetTorqueMsg << std::endl;
   ...
   targetKp.data = {120.0, 120.0, 120.0, 120.0, 5.0, 5.0, 120.0, 120.0, 120.0, 120.0, 5.0, 5.0};
   ...
   targetKd.data = {4.0, 4.0, 4.0, 4.0, 0.5, 0.5, 4.0, 4.0, 4.0, 4.0, 0.5, 0.5};
